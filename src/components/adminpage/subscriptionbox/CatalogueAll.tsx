...
import { SubscriptionBoxCard } from '@/components/shop/SubscriptionBoxCard';
import { SubscriptionBoxEditModal } from './SubscriptionBoxEditModal';
...
export const AdminSubscriptionBoxCatalogAll: React.FC = () => {
