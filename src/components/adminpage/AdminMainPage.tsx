  ...
  return (
    <div className="relative h-[700px] overflow-hidden ">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col gap-10 items-center justify-center text-white px-56 py-20">
            ...
            <span className="text-400 font-bold">Snackscription</span>
            ...
            <Link href="/shop">
            <button className="border border-gray-100 px-12 py-4 rounded-full text-2xl font-medium bg-gray-600 bg-opacity-30 transition duration-300 ease-in-out hover:bg-opacity-60">
                Shop Now
            </button>
            </Link>
        </div>
