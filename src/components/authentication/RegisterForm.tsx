  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className='flex flex-col gap-6 items-center justify-center'>
        ...
        <div>
          <input type="password" name="confirmPassword" placeholder='Confirm Password' className='border border-black p-2 rounded-md' value={confirmPassword} onChange={handleInputChange} required/>
        </div>
